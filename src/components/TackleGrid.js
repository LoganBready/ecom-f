    ...
    <div>
      ...
      <CardGroup>
        ...
        <Card>
          ...
          <Card.Body>
            <Card.Title>
              <Link to="/products/19">{name2}</Link>
              {"$" + price2}
            </Card.Title>
        ...
        <Card>
          ...
          <Card.Body>
            <Card.Title>
              <Link to="/products/20">{name3}</Link>
              {"$" + price3}
            </Card.Title>
      ...
      <CardGroup>
        <Card>
          ...
          <Card.Body>
            <Card.Title>
              <Link to="/products/21">{name4}</Link>
              {"$" + price4}
            </Card.Title>
        ...
        <Card>
          ...
          <Card.Body>
            <Card.Title>
              <Link to="/products/22">{name5}</Link>
              {"$" + price5}
            </Card.Title>
        ...
        <Card>
          ...
          <Card.Body>
            <Card.Title>
              <Link to="/products/23">{name6}</Link>
              {"$" + price6}
            </Card.Title>
